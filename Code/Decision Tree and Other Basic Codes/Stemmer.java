...
class Stemmer {
	 ...
	 * file-name ...
	 */
	public static void stemming(String input, String output) {
		char[] w = new char[501];
	...
	public static void main(String[] args) {
		...
		stemming(inputPath, outputPath);
		inputPath = "D:\\WDMProject\\data\\commentsAfterSW.txt";
		outputPath = "D:\\WDMProject\\data\\commentsAfterStem.txt";
		stemming(inputPath, outputPath);
	}
}